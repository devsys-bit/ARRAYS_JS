...
const opciones = [
  ...
  { opc: 1, nombre: "Array.prototype.flat()", accion: () => import("./arr_flat.js").then(m => ({ custom_func: m.arr_flat })) },
  { opc: 2, nombre: "Array.prototype.flatMap()", accion: () => import("./arr_flatMap.js").then(m => ({ custom_func: m.arr_flatMap })) },
]
