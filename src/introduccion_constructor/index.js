...
const opciones = [
  ...
  { opc: 1, nombre: "Array() constructor", accion: () => import("./arr_constructor.js").then(m => ({ custom_func: m.arr_constructor })) }
]
...
export const submenu = async () => {
  ...
  while (true) {
    console.clear();
    console.log("Submenú de Introduccion al Constructor:");
    console.log("---------------------------------------\n");
