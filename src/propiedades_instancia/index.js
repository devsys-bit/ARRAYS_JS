...
const opciones = [
  ...
  { opc: 1, nombre: "Array.prototype[@@unscopables]", accion: () => import("./arr_unscopables.js").then(m => ({ custom_func: m.arr_unscopables })) },
  { opc: 2, nombre: "Array.prototype.length", accion: () => import("./arr_length.js").then(m => ({ custom_func: m.arr_length })) },
]
...
export const submenu = async () => {
  ...
  while (true) {
    console.clear();
    console.log("Submenú de Propiedades de instancia:");
    console.log("------------------------------------\n");
