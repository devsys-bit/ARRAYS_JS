...
const opciones = [
  ...
  { opc: 1, nombre: "Array.prototype.includes()", accion: () => import("./arr_includes.js").then(m => ({ custom_func: m.arr_includes })) },
  { opc: 2, nombre: "Array.prototype.indexOf()", accion: () => import("./arr_indexOf.js").then(m => ({ custom_func: m.arr_indexOf })) },
  { opc: 3, nombre: "Array.prototype.lastIndexOf()", accion: () => import("./arr_lastIndexOf.js").then(m => ({ custom_func: m.arr_lastIndexOf })) },
]
...
export const submenu = async () => {
  ...
  while (true) {
    console.clear();
    console.log("Submenú de Método de Inclusión:");
    console.log("-------------------------------\n");
