...
const opciones = [
  ...
  { opc: 1, nombre: "Array.prototype.entries()", accion: () => import("./arr_entries.js").then(m => ({ custom_func: m.arr_entries })) },
  { opc: 2, nombre: "Array.prototype.keys()", accion: () => import("./arr_keys.js").then(m => ({ custom_func: m.arr_keys })) },
  { opc: 3, nombre: "Array.prototype.values()", accion: () => import("./arr_values.js").then(m => ({ custom_func: m.arr_values })) },
]
...
export const submenu = async () => {
  ...
  while (true) {
    console.clear();
    console.log("Submenú de Método de Acceso:");
    console.log("----------------------------\n");
