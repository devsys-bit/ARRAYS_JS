...
const opciones = [
  ...
  { opc: 1, nombre: "Introducción", accion: () => import("./arr_inicio.js").then(m => ({ custom_func: m.arr_inicio })) } // Carga dinámica del módulo para la introducción
]
...
export const submenu = async () => {
  ...
  while (true) {
    console.clear();
    console.log("Submenú de Introducción al Array:");
    console.log("---------------------------------\n");
