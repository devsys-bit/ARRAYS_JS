...
const opciones = [
  ...
  { opc: 1, nombre: "Array.prototype.find()", accion: () => import("./arr_find.js").then(m => ({ custom_func: m.arr_find })) },
  { opc: 2, nombre: "Array.prototype.findIndex()", accion: () => import("./arr_findIndex.js").then(m => ({ custom_func: m.arr_findIndex })) },
]
...
export const submenu = async () => {
  ...
  while (true) {
    console.clear();
    console.log("Submenú de Método de Búsqueda:");
    console.log("------------------------------\n");
